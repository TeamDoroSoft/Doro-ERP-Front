...
export function createPreviewTenants(): PreviewTenant[] {
  return [
    ...
    { id: 'preview-tenant-002', name: '스푼키친 성수', code: 'spoon-seongsu', status: 'ACTIVE', firstStore: { name: '성수 1호점', status: 'ACTIVE' }, owner: { state: 'FAILED', message: '최초 점주 계정을 등록하지 못했습니다. 업체와 첫 매장 정보는 정상적으로 처리되었습니다.' }, createdLabel: '2026-08-21' },
