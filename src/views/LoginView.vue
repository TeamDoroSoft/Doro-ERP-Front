    ...
    <section class="form-panel">
      <div class="login-card">
        ...
        <form @submit.prevent="submit">
          ...
          <div class="password-control"><label for="login-password">비밀번호</label><span class="password-field"><input id="login-password" v-model="form.password" name="password" :type="showPassword ? 'text' : 'password'" autocomplete="current-password" placeholder="비밀번호" :aria-invalid="Boolean(errors.password)" /><button type="button" :aria-label="showPassword ? '비밀번호 숨기기' : '비밀번호 보기'" @click="showPassword = !showPassword">{{ showPassword ? '숨김' : '보기' }}</button></span><small v-if="errors.password">{{ errors.password }}</small></div>
